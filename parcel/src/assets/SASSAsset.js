...
class SASSAsset extends Asset {
  ...
  async parse(code) {
    ...
    try {
      // NOTE: always push local styles dir onto include path because @smui modules expect a local _ sass file.
      opts.includePaths.push('src/styles');
      opts.includePaths.push('node_modules');
